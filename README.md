...
<img src="assets/rednet-banner.svg" alt="REDNET Airin Skillbook" width="920">

# REDNET Airin Skillbook

**Choose a language / Выберите язык**

[English README](README-EN.md) · [Русское описание](README-RU.md)
...
| Banner | QMeta operator | Airin icon |
|---|---|---|
| [assets/rednet-banner.svg](assets/rednet-banner.svg) | [assets/qmeta-operator.svg](assets/qmeta-operator.svg) | [assets/airin-icon.svg](assets/airin-icon.svg) |
...
| Баннер | Оператор QMeta | Иконка Airin |
|---|---|---|
| [assets/rednet-banner.svg](assets/rednet-banner.svg) | [assets/qmeta-operator.svg](assets/qmeta-operator.svg) | [assets/airin-icon.svg](assets/airin-icon.svg) |
